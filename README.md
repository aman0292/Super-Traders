...
- [Live Demo](https://super-traders-clint.netlify.app/)
...
```bash
$ git@github.com:clintonjosephs/super-traders.git
$ cd super-traders
```
#### Run project
...
Feel free to check the [issues page](https://github.com/clintonjosephs/super-traders/issues).
